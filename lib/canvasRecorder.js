...
function CanvasRecorder(htmlElement, config) {
  ...
  document.title = 'GLITCH GIF VJ V1.1';
        document.getElementById('messagebox').innerHTML = 'Generating WebM';
    ...
    this.stop = function(callback) {
        ...
        this.getWebPImages(function() {
            ...
            whammy.compile(function(blob) {
                document.getElementById('messagebox').innerHTML = 'Recording finished!';
